...
public class LayananAkademikSIAKAD11 {
    public static void main(String[] args) {
        ...
        SingleLinkedListAkademik11 SLL = new SingleLinkedListAkademik11();
        int pilihan;
        do {
            ...
            switch (pilihan) {
                ...
                MahasiswaAkademik11 mhs = new MahasiswaAkademik11 (nim, nama, prodi, kelas);
                antrian.tambahAntrian (mhs);
                
                break;
                case 2:
                MahasiswaAkademik11 dilayani = antrian.layaniMahasiswa();
                if (dilayani != null) {
