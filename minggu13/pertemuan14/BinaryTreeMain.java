...
public class BinaryTreeMain {
    public static void main(String[] args) {
        ...
        System.out.println("\nDaftar semua mahasiswa setelah 1 mahasiswa dihapus (inorder traversal):");
        bst.traverseInOrder(bst.root);

        // Tugas Praktikum

        // add data secara rekursif
        System.out.println("\nMenambahkan mahasiswa menggunakan method rekursif:");
        bst.addRekursif(new Mahasiswa11("244160150", "Gita", "A", 3.90));
        bst.traverseInOrder(bst.root);

        //cari IPK terkecil dan terbesar
